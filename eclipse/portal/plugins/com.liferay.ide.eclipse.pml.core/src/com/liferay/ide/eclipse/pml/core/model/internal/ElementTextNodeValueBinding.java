...
public final class ElementTextNodeValueBinding
...

{
	...
	public String read() {
		...
		final XmlElement element = xml( false ).getChildElement( params[0], false );
	...
	public void write( final String value ) {
		...
		xml( true ).getChildNode( this.path, true ).setText( getIdText( val ) );
	}
